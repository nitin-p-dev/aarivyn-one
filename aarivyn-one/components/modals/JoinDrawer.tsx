        ...
        <div className="p-6">
          {submitted ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <div className="mb-4 h-16 w-16 rounded-full bg-orange-500/20 flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg bg-white/5 px-4 py-2 text-white placeholder-gray-500 border border-white/10 focus:border-orange-500 focus:outline-none"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full rounded-lg bg-white/5 px-4 py-2 text-white border border-white/10 focus:border-orange-500 focus:outline-none"
                  required
                >
              ...
              <div className="flex gap-4 pt-6 border-t border-white/10">
                <button
                  type="button"
                  onClick={() => setShowJoinDrawer(false)}
                  className="flex-1 rounded-lg border border-white/20 px-4 py-2 font-medium text-white transition-all hover:bg-white/5"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 rounded-lg bg-orange-500/30 px-4 py-2 font-medium text-orange-300 transition-all hover:bg-orange-500/40"
                >
                  Apply
                </button>
              </div>
